...
#                print (mu_list[k])
    ...
    def fit(self,iterration,delta = 0.5):
        self.expectation()
        self.maximization()
...
def predict(gmm_model,data):
    for i in range (len(data)):
        print (gmm_model.label_data(data[i]))
